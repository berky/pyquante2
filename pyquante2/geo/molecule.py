...
class molecule(object):
    ...
    def xyz(self, title=None, fobj=None):
        """Output molecule in
        [xyz format](http://en.wikipedia.org/wiki/XYZ_file_format).
        """
        if title is None:
            title = self.name
    ...
    def pyquante1(self, name="pyq2 molecule"):
        """Make a PyQuante1 Molecule object that can be passed into that
        program for testing/debugging purposes.
        """
